...
public struct ToastStyle {
     ...
     */
    public var backgroundColor: UIColor = UIColor(red: 41/255.0, green: 42/255.0, blue: 48/255.0, alpha: 1)
    ...
    /**
     The title font. Default is `.mediumSystemFont(16.0)`.
     */
    public var titleFont: UIFont = UIFont.systemFont(ofSize: 14, weight: .medium)
    ...
    /**
     The fade in/out animation duration. Default is 0.25.
     */
