 ...
 * @catalog 首页
 * @title 资讯评论点赞
 * @description 资讯评论点赞接口
 * @method post
 * @url https://shiyao.yaojk.com.cn/home/articleCommentLike
 ...
 * @number 99
 */
class ArticleCommentLikeAction extends Action
{
    /**
    ...
    public function run()
    {
        ...
        $result = HomeService::addArticleCommentLike($uid, $commentId);
