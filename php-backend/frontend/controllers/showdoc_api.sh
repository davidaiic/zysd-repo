...
# 
api_key="78607f24f53d160b188eb81215b9af35228787288" 			#api_key
api_token="fd0888a182af83d76da6e5a4e5be230d1041742241" 	#api_token
url="http://47.100.107.141:4999/server/?s=/api/open/fromComments" #同步到的url。使用www.showdoc.com.cn的不需要修改，使用私有版的请修改
#
#
#
#
