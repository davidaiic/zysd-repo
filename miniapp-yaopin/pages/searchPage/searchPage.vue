...
<template>
	<view class="mainWrap">
		...
		<view class="content" :style="{ height: scrollViewheight - 70 + 'px' }">
			<SearchList :searchModel.sync="searchModel" @back="goHome()" :placeholder="default_placeholder" :defaultValue="defaultValue" @search="goToSearch" />
...
export default {
	...
	onLoad(options) {
		this.default_placeholder = options.keyword || "";
