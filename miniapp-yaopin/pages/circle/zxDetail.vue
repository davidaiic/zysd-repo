...
export default {
    ...
    methods: {
        ...
        getCommentList() {
            ...
            articleInfoReq(params).then(res => {
        ...
        toCommentLike(item, isArticle) {
			...
			let requestData = isArticle ? articleLikeReq(params):
								articleCommentLikeReq(params)
        ...
        shareComment(item) {
            ...
            that.share = {
                title: '你收到来自朋友的一条资讯',
                path: `pages/circle/zxDetail?articleId=${that.articleId}`
            }
        },
        popComment() {
