...
<template>
    <u-popup :show="show" mode="bottom" @close="close" @open="open">
        <view class="pop-content">
            <u-textarea v-model="inputValue" placeholder="请输入内容" height="90" adjustPosition
                :cursorSpacing="space" :focus="isFocus"></u-textarea>
            <view class="picArray">
                <e-upload-item class="picArray_item" v-model="picList" maxCount='8' width="100rpx" height="100rpx"
                    placeHolder="上传">
                </e-upload-item>
            </view>
...
import {addCommentReq} from '@/api/home.js'
export default {
    props: {
        pop: {
            type: Boolean,
    ...
    computed: {
        space() {
			...
			return this.picList.length > 6 ? 360 : 310
        }
    },
    onLoad(option) {
    },
