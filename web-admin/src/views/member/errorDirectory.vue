<template>
  <div class="app-container">
    ...
    <el-form ref="form" :inline="true" :model="form" size="small">
      ...
      <el-form-item label="提交时间" prop="beginDate">
    ...
    >
      ...
      <el-table-column align="center" label="类目">
        <template slot-scope="scope">
          <el-tag v-for="item in scope.row.keywords" :key="item" class="center5">
            {{ item }}
          </el-tag>
        </template>
      </el-table-column>

      <el-table-column property="created" align="center" label="提交时间" />
    </el-table>
...
<script>
import { errorDirectory } from '@/api/member'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      errorDirectory(this.listQuery).then(response => {
