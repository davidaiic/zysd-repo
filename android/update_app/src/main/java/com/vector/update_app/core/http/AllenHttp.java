package com.vector.update_app.core.http;

import com.vector.update_app.core.VersionParams;
...
public class AllenHttp {
    ...
    private static <T extends Request.Builder> T assembleHeader(T builder, VersionParams versionParams) {
        com.vector.update_app.core.http.HttpHeaders headers = versionParams.getHttpHeaders();
        if (headers != null) {
